...
# Carregar dados
malha_viaria = gpd.read_file('/app/Risco.geojson')
hexagonos_h3 = gpd.read_file('/app/H3.geojson')
...
hexagonos_h3 = gpd.read_file('/app/hexagonos_h3_com_risco.geojson')
areas_urbanas = gpd.read_file('/app/AU.geojson')
municipios = gpd.read_file('/app/MUN_SP.geojson')
